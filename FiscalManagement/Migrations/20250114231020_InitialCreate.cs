    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Audite", x => x.AuditID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contribuabili", x => x.ContribuabilID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CerereID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipCerere = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DataDepunerii = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cereri_Contribuabili_ContribuabilID",
                        column: x => x.ContribuabilID,
                        principalTable: "Contribuabili",
                        principalColumn: "ContribuabilID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plati_Contribuabili_ContribuabilID",
                        column: x => x.ContribuabilID,
                        principalTable: "Contribuabili",
                        principalColumn: "ContribuabilID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cereri_ContribuabilID",
                table: "Cereri",
                column: "ContribuabilID");

            migrationBuilder.CreateIndex(
                name: "IX_Plati_ContribuabilID",
                table: "Plati",
                column: "ContribuabilID");
        }
